 ...
 *
 * Written by Luther Tychonievich by consulting "PNG: The Definitive Guide" by
 * Greg Roelofs <http://www.libpng.org/pub/png/book/>, with a focus on brevity
 * for the common case. Notably, I omitted the recommended setjmp/longjmp error
 * handling entirely.
 */
...
image_t* load_image(const char* filename) {
  ...
  if (color == PNG_COLOR_TYPE_GRAY_ALPHA || color == PNG_COLOR_TYPE_GRAY)
